# -*- coding: utf-8 -*-
"""
Created on Thu Dec 21 16:32:09 2023


INSTRUCTIONS
De-bug Task. Please ensure you have all relevant packages installed.

There are multiple ways to solve the problem in this script.

Do not re-write SARIMAX regressor, only a small change is needed.

Fixing the script only requires an additional line to be added.
...
for i in range(len(df)-n_steps, len(df)):
    ...
    forecast = model_fit.get_forecast(steps=1, disp=0)
